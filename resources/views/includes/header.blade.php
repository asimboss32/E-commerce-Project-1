    ...
    <div class="container">
        <div class="header-top-wrapper">
            <a href="{{route('base')}}" class="brand-logo-outer">
                <img src="{{asset('backend/images/setting/'.$siteSettings->logo)}}" style="width:100px; height:auto;" alt="Logo">
            </a>
            ...
            <div class="header-top-right-outer">
                ...
                <div class="header-top-right-item">
                    <a href="{{url('/admin/login')}}" class="admin-login-link" style="margin-right:15px; font-weight:bold; color:#100f0f;">
                        Login
                    </a>
                </div>
